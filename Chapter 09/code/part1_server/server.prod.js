  ...
  app.get('*', function (req, res) {
    (0, _reactRouter.match)({ routes: _routes.routes, location: req.url }, function (err, redirectLocation, props) {
      if (err) {
        ...
        //var markup = renderToString(React.createElement(RoutingContext, props));
        var initialState = { settings: _settings2.default };
        //res.send(renderLayout({settings, markup, initialState}));
        ...
        var stream = _server2.default.renderToString(_react2.default.createElement(_reactRouter.RoutingContext, props));
